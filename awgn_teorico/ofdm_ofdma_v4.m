...
% AWGN TEORICO - Nao aplica Rayleigh channel
for i=1:1:length(EbNo)
        ...
        while(sum_ber_u1 < 200 && sum_ber_u2 < 500)
            i
            iteracao = iteracao + 1;
            %tx 
            ...
            h1 = 1;%((randn(1,1)+1i*randn(1,1)))/ (sqrt(2) * sqrt(1));
            h2 = 1;%((randn(1,10)+1i*randn(1,10)))/ (sqrt(2) * sqrt(10));
            h3 = 1;%((randn(1,20)+1i*randn(1,20)))/ (sqrt(2) * sqrt(20));
            h4 = 1;%((randn(1,30)+1i*randn(1,30)))/ (sqrt(2) * sqrt(30));
            ...
            Hestimado_1 = 1;%interpft((pilotos_rx_1(pilot_positions)),N);
            Hestimado_2 = 1;%interpft((pilotos_rx_2(pilot_positions)),N);
            Hestimado_3 = 1;%interpft((pilotos_rx_3(pilot_positions)),N);
            Hestimado_4 = 1;%interpft((pilotos_rx_4(pilot_positions)),N);
